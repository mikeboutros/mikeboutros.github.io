<script>
    let github = "./svg/github.svg";
	// import Techcerts from "./Techcerts.svelte";
...
<style lang="scss">
	...
	// 		grid-template-rows: 200px 1fr 200px 85px;
	// 	}
	// }
	...
	// 	section {
	// 		grid-template-columns: 30px 1fr 30px;
	// 		grid-template-rows: 200px 1fr 200px 110px;
	// 	}
	// }
...
<section>
	...
	<!-- <div class="link1">
		<h2><a href="./Techskills">SKILLS</a></h2>
	</div>
	<div class="link2">
		<h2><a href="./Techcerts">CERTS</a></h2>
	</div> -->
		

	<footer>
		<a href="https://github.com/mikeboutros"> <img src = { github } class="icons" alt="github icon" /> </a>
	</footer>
</section>